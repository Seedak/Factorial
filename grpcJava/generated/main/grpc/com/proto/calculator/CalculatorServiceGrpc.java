...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.calculator.CalculatorRequest,
      com.proto.calculator.CalculatorFactorialResponse> getFactorialMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Factorial",
      requestType = com.proto.calculator.CalculatorRequest.class,
      responseType = com.proto.calculator.CalculatorFactorialResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.calculator.CalculatorRequest,
      com.proto.calculator.CalculatorFactorialResponse> getFactorialMethod() {
    io.grpc.MethodDescriptor<com.proto.calculator.CalculatorRequest, com.proto.calculator.CalculatorFactorialResponse> getFactorialMethod;
    if ((getFactorialMethod = CalculatorServiceGrpc.getFactorialMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getFactorialMethod = CalculatorServiceGrpc.getFactorialMethod) == null) {
          CalculatorServiceGrpc.getFactorialMethod = getFactorialMethod = 
              io.grpc.MethodDescriptor.<com.proto.calculator.CalculatorRequest, com.proto.calculator.CalculatorFactorialResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "calculator.CalculatorService", "Factorial"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.CalculatorRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.CalculatorFactorialResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CalculatorServiceMethodDescriptorSupplier("Factorial"))
                  .build();
          }
        }
     }
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void factorial(com.proto.calculator.CalculatorRequest request,
        io.grpc.stub.StreamObserver<com.proto.calculator.CalculatorFactorialResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.proto.calculator.CalculatorRequest,
                com.proto.calculator.CalculatorFactorialResponse>(
  ...
  public static final class CalculatorServiceBlockingStub extends io.grpc.stub.AbstractStub<CalculatorServiceBlockingStub> {
    ...
    /**
     */
    public com.proto.calculator.CalculatorFactorialResponse factorial(com.proto.calculator.CalculatorRequest request) {
      return blockingUnaryCall(
  ...
  public static final class CalculatorServiceFutureStub extends io.grpc.stub.AbstractStub<CalculatorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.calculator.CalculatorFactorialResponse> factorial(
        com.proto.calculator.CalculatorRequest request) {
      return futureUnaryCall(
  ...
  private static final int METHODID_FACTORIAL = 2;
  private static final int METHODID_AVERAGE = 3;
  private static final int METHODID_ODD_EVEN = 4;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_FACTORIAL:
          serviceImpl.factorial((com.proto.calculator.CalculatorRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.calculator.CalculatorFactorialResponse>) responseObserver);
          break;
        default:
