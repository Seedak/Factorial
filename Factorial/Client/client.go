...
func Start(port string) {
	...
	fmt.Println("Factorial Request")
	var x int32 = 6
	resFactorial, err := client.Factorial(ctx, &calculatorpb.CalculatorRequest{
		Number: x,
	})
	if resFactorial.GetResult() > 0  {
		fmt.Println("Factorial of ", x, "is", resFactorial.GetResult())
	}
